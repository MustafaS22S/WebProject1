...
<head>
    ...
    <!----======== CSS ======== -->
    <link rel="stylesheet" href="./frontend/admins/style.css">
...
<body>
    <nav>
        <div class="logo-name">
            <div class="logo-image">
                <img src="./frontend/admins/images/logo.png" alt="">
            </div>
    ...
    <section class="dashboard">
        <div class="top">
            ...
            <img src="./frontend/admins/images/profile.jpg" alt="">
        </div>
    ...
    <script src="./frontend/admins/script.js"></script>
</body>
</html>